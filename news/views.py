...
def news_list(request):
    ...
    context = {
        ...
        "title": "News",
        "meta_description": "Latest news and updates from AI Marketing Platform",
    }
...
def category_list(request, slug):
    ...
    context = {
        ...
        "meta_description": f"Latest news and updates about {category.name} from AI Marketing Platform",
    }
