...
from todiane.storage import SecureStorage, PublicStorage
from django.db.models import Avg
from todiane.utils import custom_slugify
...
class Product(models.Model):
    ...
    # Media - Platform-specific installers
    windows_file = models.FileField(
        upload_to="products/windows/",
        null=True,
        blank=True,
        storage=SecureStorage(),
        help_text="Upload the Windows installer (ZIP/EXE).",
    )

    mac_file = models.FileField(
        upload_to="products/mac/",
        null=True,
        blank=True,
        storage=SecureStorage(),
        help_text="Upload the macOS installer (ZIP/DMG).",
    )
...
class OrderItem(models.Model):
    ...
    # Which platform did the user purchase?
    ...
    def get_download_file(self):
        if self.platform == "pdf" and self.product.pdf_file:
            return self.product.pdf_file
        if self.platform == "mac" and self.product.mac_file:
            return self.product.mac_file
        if self.platform == "windows" and self.product.windows_file:
            return self.product.windows_file
        return None
