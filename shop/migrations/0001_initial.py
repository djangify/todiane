    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('windows_file', models.FileField(blank=True, help_text='Upload the Windows installer (ZIP/EXE).', null=True, storage=todiane.storage.SecureStorage(), upload_to='products/windows/')),
                ('mac_file', models.FileField(blank=True, help_text='Upload the macOS installer (ZIP/DMG).', null=True, storage=todiane.storage.SecureStorage(), upload_to='products/mac/')),
                ('pdf_file', models.FileField(blank=True, help_text='Upload the PDF file.', null=True, storage=todiane.storage.SecureStorage(), upload_to='products/pdfs/')),
                ('preview_file', models.FileField(blank=True, null=True, storage=todiane.storage.PublicStorage(), upload_to='products/previews/')),
                ('preview_image', models.ImageField(blank=True, null=True, storage=todiane.storage.PublicStorage(), upload_to='products/images/')),
                ('video_url', models.URLField(blank=True, help_text='Optional YouTube or Vimeo URL to display on the product page', null=True)),
                ('video_file', models.FileField(blank=True, help_text='Upload a short MP4 file to display as product video', null=True, storage=todiane.storage.PublicStorage(), upload_to='products/videos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(choices=[('windows', 'Windows'), ('mac', 'macOS'), ('pdf', 'PDF')], default='windows', max_length=20)),
